...
- ``EI0002``: **Código Identificador Interno incorrecto**.
  ...
  o más caracteres. El valor indicado **VALUE** no sigue el formato.
...
- ``I0004``: **Código identificador interno duplicado**.
...
- ``EI0008``: **Materia competencial desconocida o incorrecta**.
  ...
  Los valores esperados están en la tabla de materias, pero **VALUE** no
  está entre ellos.
...
- ``EI0009``: **Email o login de usuario incorrecto**.
  ...
  No puedo interpretar **VALUE** como un *email* o un login de usuario.
